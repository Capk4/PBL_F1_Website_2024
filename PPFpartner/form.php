...
<html lang='eng'>
    ...
    <body>
        ...
        <header>
            ...
            <nav class="navbar">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="http://localhost/myweb/PPFpartner/form.php"><b>Take Form</b></a></li>
        ...
        <input type="radio" class="Fclick" name="living_space" value="1" required>
        ...
        <input type="radio" class="Fclick" name="living_space" value="2" required>
        ...
        <input type="radio" class="Fclick" name="living_space" value="3" required>
        ...
        <input type="radio" class="Fclick" name="activity_level" value="10" required>
        ...
        <input type="radio" class="Fclick" name="activity_level" value="20" required>
        ...
        <input type="radio" class="Fclick" name="activity_level" value="30" required>
